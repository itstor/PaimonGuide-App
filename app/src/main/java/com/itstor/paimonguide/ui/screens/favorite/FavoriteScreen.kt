...
fun FavoriteScreen(
    ...
    val characterDataResult by favoriteViewModel.favoriteCharacter.observeAsState()

    LaunchedEffect(Unit) {
        favoriteViewModel.loadFavoriteCharacter()
    }

    Column (modifier = modifier.fillMaxSize()) {
        AppBar(appBarTitle = stringResource(R.string.favorites_title))
        Box(
            modifier = Modifier
                .fillMaxSize()
